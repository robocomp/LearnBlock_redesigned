...
class Robot(Client):
    ...
    def deviceSendEmotion(self, _emotion):
        ...
        if _emotion is Emotions.Joy:
            trigger = rcozmo.anim.Triggers.PeekABooGetOutHappy
        elif _emotion is Emotions.Sadness:
            trigger = rcozmo.anim.Triggers.PeekABooGetOutSad
        elif _emotion is Emotions.Surprise:
            trigger = rcozmo.anim.Triggers.PeekABooSurprised
        elif _emotion is Emotions.Disgust:
            trigger = None
        elif _emotion is Emotions.Anger:
            trigger = rcozmo.anim.Triggers.DriveEndAngry
        elif _emotion is Emotions.Fear:
            trigger = rcozmo.anim.Triggers.CodeLabScaredCozmo
        elif _emotion is Emotions.Neutral:
            trigger = rcozmo.anim.Triggers.NeutralFace
