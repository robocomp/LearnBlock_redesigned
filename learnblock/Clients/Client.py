...
import numpy as np, time, Ice, os, subprocess
from learnblock import PATHINTERFACES, getAprilTextDict
from learnblock.utils.Functions import getFunctions
...
class Client(Thread):
    ...
    def __init__(self,_miliseconds=100):
        ...
        self.__emotionrecognition_proxy = connectICEProxy("emotionrecognition:tcp -h localhost -p 10006", RoboCompEmotionRecognition.EmotionRecognitionPrx)
        # Remote object connection for AprilTag
        self.__apriltagProxy = connectICEProxy("apriltag:tcp -h localhost -p 25000", RoboCompApriltag.ApriltagPrx)
        # self.start()
